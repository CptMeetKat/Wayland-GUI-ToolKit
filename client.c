...
int main(int argc, char *argv[])
{
    ...
    registerComponent(&state, create_test_textfield(300, 200, "DejaVuSerif.ttf", 200, "HeyZukoHere")->base);
    registerComponent(&state, create_test_textfield(400, 10, "DejaVuSerif.ttf", 26, "aW")->base);
